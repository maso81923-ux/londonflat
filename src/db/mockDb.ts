...
const INITIAL_LISTINGS: PropertyListing[] = [
  ...
  },
  {
    id: 'listing-4',
    provider_id: 'user-sarah',
    title: 'Bright Studio Flat in Hampstead Village',
    description: 'A charming self-contained studio in the heart of picturesque Hampstead Village. Recently refurbished with a modern kitchenette, underfloor heating, and private street entrance. Moments from Hampstead Heath and the Northern Line.',
    price_per_month: 1350,
    deposit: 1350,
    address: '7 Flask Walk, Hampstead',
    borough: 'Camden',
    postcode: 'NW3 1HJ',
    type: 'room',
    listing_purpose: 'rent',
    ...
    is_bills_included: true,
    amenities: ['Studio', 'Underfloor Heating', 'Private Entrance', 'Furnished', 'Fibre Wifi'],
    images: [
      'https://images.unsplash.com/photo-1536376072262-38c0135946c8?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    id: 'listing-5',
    provider_id: 'user-apex',
    title: 'Spacious 2-Bed Flat in Canary Wharf',
    description: 'Executive 2-bedroom apartment on the 22nd floor with panoramic Thames views. Floor-to-ceiling windows, integrated smart home system, residents\' gym and pool. 5-minute walk to Canary Wharf station.',
    price_per_month: 3200,
    deposit: 3200,
    address: '10 Park Drive, Canary Wharf',
    ...
    is_bills_included: false,
    amenities: ['River Views', 'Gym', 'Pool', 'Concierge', 'Smart Home', 'Parking'],
    images: [
  ...
  },
  {
    id: 'listing-6',
    provider_id: 'user-prestige',
    title: 'Period Conversion 1-Bed in Notting Hill',
    description: 'Beautifully restored first-floor flat in a white stucco Victorian terrace. High ceilings, original cornicing, sash windows, and a west-facing private balcony. Portobello Road and the vintage market are on your doorstep.',
    price_per_month: 2100,
    deposit: 2100,
    address: '42 Lansdowne Road, Notting Hill',
    borough: 'Kensington & Chelsea',
    postcode: 'W11 3LP',
    type: 'entire_flat',
    listing_purpose: 'rent',
    ...
    is_bills_included: false,
    amenities: ['Balcony', 'High Ceilings', 'Original Features', 'Dishwasher', 'Bike Storage'],
    images: [
  ...
  },
  {
    id: 'listing-7',
    provider_id: 'user-sarah',
    title: 'Ensuite Room in Angel Townhouse',
    description: 'Large double ensuite room on the top floor of a quiet Islington townhouse. Skylight windows, built-in wardrobes, and exclusive use of the roof terrace. Sharing with one friendly professional and a rescue cat.',
    price_per_month: 980,
    deposit: 980,
    address: '18 Duncan Street, Angel',
    borough: 'Islington',
    postcode: 'N1 8BW',
    type: 'room',
    listing_purpose: 'rent',
    ...
    is_bills_included: true,
    amenities: ['Ensuite', 'Roof Terrace', 'All Bills Included', 'Washing Machine', 'Garden'],
    images: [
  ...
  },
  {
    id: 'listing-8',
    provider_id: 'user-apex',
    title: '3-Bed Family Home in Richmond',
    description: 'Detached Edwardian family home overlooking Richmond Green. Three double bedrooms, large country kitchen, mature walled garden, and off-street parking. Outstanding schools within catchment. Richmond station 8 minutes\' walk.',
    price: 1850000,
    deposit: 0,
    address: '14 The Green, Richmond',
    ...
    is_bills_included: false,
    amenities: ['Garden', 'Parking', 'Fireplace', 'Cellar', 'Outstanding Schools'],
    images: [
      'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1600566753086-00f18f6b0050?auto=format&fit=crop&w=800&q=80'
    ],
    is_verified: true,
    latitude: 51.461,
    longitude: -0.304,
  ...
  },
  {
    id: 'listing-9',
    provider_id: 'user-prestige',
    title: 'Penthouse Studio in South Bank',
    description: 'Stunning penthouse studio with floor-to-ceiling views over the Thames and London Eye. Bespoke fitted furniture, limestone bathroom, and residents\' roof garden. Seconds from the Southbank Centre and Waterloo.',
    price_per_month: 1950,
    deposit: 1950,
    address: '22 Upper Ground, South Bank',
    borough: 'Lambeth',
    postcode: 'SE1 9PD',
    type: 'room',
    listing_purpose: 'rent',
    ...
    is_bills_included: true,
    amenities: ['Thames View', 'Roof Garden', 'Concierge', 'Furnished', 'Gym', 'City View'],
    images: [
  ...
  },
  {
    id: 'listing-10',
    provider_id: 'user-sarah',
    title: 'Garden Flat 1-Bed in Dulwich Village',
    description: 'Ground-floor flat in a handsome Victorian villa with direct access to a private south-facing garden. Newly fitted kitchen, wood burner, and original floorboards. Dulwich Picture Gallery and the village shops are a short stroll away.',
    price_per_month: 1750,
    deposit: 1750,
    address: '5 College Road, Dulwich',
    borough: 'Southwark',
    postcode: 'SE21 7BG',
    type: 'entire_flat',
    listing_purpose: 'rent',
    ...
    is_bills_included: false,
    amenities: ['Private Garden', 'Wood Burner', 'New Kitchen', 'Quiet Street', 'Parking'],
    images: [
      'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    id: 'listing-11',
    provider_id: 'user-apex',
    title: 'Warehouse Conversion Loft in Hackney Wick',
    description: 'Vast open-plan live/work loft in a converted Victorian warehouse. Double-height ceilings, polished concrete floors, Crittall windows, and a mezzanine bedroom. Vibrant creative community, canalside cafes, and the Overground 5 minutes away.',
    price_per_month: 2800,
    deposit: 2800,
    address: 'Unit 3, White Post Lane, Hackney Wick',
    borough: 'Hackney',
    postcode: 'E9 5EN',
    type: 'entire_flat',
    listing_purpose: 'rent',
    ...
    is_bills_included: false,
    amenities: ['Loft', 'Mezzanine', 'Crittall Windows', 'Concrete Floors', 'Live/Work', 'Canalside'],
    images: [
  ...
  },
  {
    id: 'listing-12',
    provider_id: 'user-prestige',
    title: '2-Bed Maisonette in Primrose Hill',
    description: 'Charming split-level maisonette on a coveted Primrose Hill crescent. Two double bedrooms, eat-in kitchen with bi-fold doors to a patio garden, and a bright reception room with period fireplace. The park and Camden Market are a short walk away.',
    price: 975000,
    deposit: 0,
    address: '33 Regent\'s Park Road, Primrose Hill',
    borough: 'Camden',
    postcode: 'NW1 7TL',
    type: 'entire_flat',
    listing_purpose: 'sale',
    ...
    is_bills_included: false,
    amenities: ['Patio Garden', 'Period Fireplace', 'Bi-fold Doors', 'Split-level', 'Eat-in Kitchen'],
    images: [
      'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    id: 'listing-13',
    provider_id: 'user-sarah',
    title: 'Cozy Room in Kensal Rise Share',
    description: 'Warm and welcoming double room in a beautifully kept Victorian terrace. Sharing with two young professionals (designer and teacher). Large shared living room, modern kitchen, and a sun-trap back garden. Overground and bakeries within 3 minutes.',
    price_per_month: 850,
    deposit: 850,
    address: '26 Chamberlayne Road, Kensal Rise',
    borough: 'Brent',
    postcode: 'NW10 3JD',
    type: 'room',
    listing_purpose: 'rent',
    ...
    is_bills_included: true,
    amenities: ['Garden', 'Modern Kitchen', 'All Bills Included', 'Close to Transport', 'Friendly Housemates'],
    images: [
      'https://images.unsplash.com/photo-1598928506311-c55ded91a20c?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=800&q=80'
    ],
...
const INITIAL_SERVICE_PROVIDERS: ServiceProvider[] = [
  ...
  // 5b. Legal Eviction & Case Handling
  {
    ...
    description: 'Section 21 and Section 8 eviction specialists. 24-hour notice preparation, accelerated possession claims, and court representation for London landlords.',
    category: 'legal-eviction',
    subcategories: ['Section 21', 'Section 8', 'Possession Claims', 'Court Representation'],
    borough: 'Islington',
    address: '145 City Road, London EC1V 1AZ',
    phone: '+44 20 7946 2101',
  ...
  },
  {
    ...
    description: 'Specialist tenant solicitors for deposit protection disputes, illegal eviction defence, disrepair claims, and housing condition enforcement across Greater London.',
    category: 'legal-eviction',
    subcategories: ['Deposit Disputes', 'Illegal Eviction', 'Disrepair Claims', 'Tenant Defence'],
    borough: 'Southwark',
    address: '42 Borough High Street, London SE1 1XW',
    phone: '+44 20 7946 2102',
